...
- created_at: 2026-05-10T02:19:52
- input_jsonl: `data/category_classifier/places365_v1/processed_service_prompt/test.jsonl`
- rows: 255
...
- output_dir: `/home/cvlab/Desktop/Yoon/LighTrip-AI/experiments/gemma_category_compare/results/service_prompt_vs_direct`

## Metric Summary

| method | rows | accuracy | macro_f1 | mean_sec | p95_sec | parse_success | consistency |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| classifier_existing_draft | 255 | 0.6588 | 0.6480 | 0.0005 | 0.0006 | - | - |
| gemma_direct | 255 | 0.5922 | 0.5313 | 0.7024 | 0.7807 | 1.0000 | - |
| split_pipeline | 255 | 0.7020 | 0.6844 | 0.5948 | 0.6803 | - | - |
