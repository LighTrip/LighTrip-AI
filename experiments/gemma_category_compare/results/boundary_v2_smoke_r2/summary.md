...
- created_at: 2026-05-10T22:17:26
...
- output_dir: `/home/cvlab/Desktop/Yoon/LighTrip-AI/experiments/gemma_category_compare/results/boundary_v2_smoke_r2`

## Metric Summary

| method | rows | accuracy | macro_f1 | mean_sec | p95_sec | parse_success | consistency |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| split_pipeline | 7 | 0.8571 | 0.8095 | 18.5774 | 20.3801 | - | - |
