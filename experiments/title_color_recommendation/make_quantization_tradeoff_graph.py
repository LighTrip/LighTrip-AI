...
LABEL_STUDENT_KD_FP32 = "Student KD FP32"
LABEL_STUDENT_KD_PTQ_FP16 = "Student KD PTQ FP16"
LABEL_STUDENT_KD_PTQ_INT8_DYNAMIC = "Student KD PTQ INT8 Dynamic"
LABEL_STUDENT_QAT_FP32 = "Student QAT FP32"
LABEL_STUDENT_QAT_PTQ_FP16 = "Student QAT + PTQ FP16"
LABEL_STUDENT_QAT_PTQ_INT8_DYNAMIC = "Student QAT + PTQ INT8 Dynamic"
Y_LABEL_NDCG5 = "NDCG@5"

PRACTICAL_CANDIDATES = {
    LABEL_STUDENT_KD_FP32,
...
SELECTED_LABEL = LABEL_STUDENT_QAT_PTQ_FP16
...
def short_label(row: QuantizationPresentationRow) -> str:
    label = row.label
    replacements = {
        LABEL_STUDENT_KD_FP32: "Student\nFP32",
        LABEL_STUDENT_KD_PTQ_FP16: "Student\nPTQ FP16",
        LABEL_STUDENT_KD_PTQ_INT8_DYNAMIC: "Student\nPTQ INT8",
        LABEL_STUDENT_QAT_FP32: "QAT\nFP32",
        LABEL_STUDENT_QAT_PTQ_FP16: "QAT+PTQ\nFP16",
        LABEL_STUDENT_QAT_PTQ_INT8_DYNAMIC: "QAT+PTQ\nINT8",
    }
...
def annotation_offset(row: QuantizationPresentationRow) -> tuple[int, int]:
    offsets = {
        LABEL_STUDENT_KD_FP32: (-42, -26),
        LABEL_STUDENT_KD_PTQ_FP16: (-73, 8),
        LABEL_STUDENT_KD_PTQ_INT8_DYNAMIC: (8, 18),
        LABEL_STUDENT_QAT_FP32: (8, -18),
        LABEL_STUDENT_QAT_PTQ_FP16: (10, 12),
        LABEL_STUDENT_QAT_PTQ_INT8_DYNAMIC: (12, -17),
    }
...
def draw_candidate_point(
    axis: Any,
    row: QuantizationPresentationRow,
    precision_colors: dict[str, str],
    precision_faces: dict[str, str],
) -> None:
